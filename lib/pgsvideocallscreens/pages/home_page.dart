...
class pgsMyHomePage extends StatefulWidget {
  pgsMyHomePage({Key? key, String? pgsusername}) : super(key: key);

  @override
  _pgsMyHomePageState createState() => _pgsMyHomePageState();
}

class _pgsMyHomePageState extends State<pgsMyHomePage> {
  final userNameController = TextEditingController();
  final channelNameController = TextEditingController();
  bool validateError = false;
  // FirebaseAuth _auth = FirebaseAuth.instance;
  String _userName = pgsusername!;

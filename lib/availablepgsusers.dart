...
class availablepgsusers extends StatefulWidget {
  const availablepgsusers({Key? key}) : super(key: key);

  @override
  _availablepgsusersState createState() => _availablepgsusersState();
}

TextEditingController titleController = new TextEditingController();
TextEditingController authorController = new TextEditingController();

class _availablepgsusersState extends State<availablepgsusers> {
  @override
...
class BookList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream:
          FirebaseFirestore.instance.collection('agorachannels').snapshots(),
